...
mysqldump -umarshall -pmar5ha11 pessto_phase_iii ntt_standards filetype_key_calibration filetype_key_reduction_stage transientBucketSummaries astronotes_transients atel_coordinates atel_names marshall_transient_akas fits_header_keywords pessto_tran_cat_column_desc PESSTO_TRAN_CAT pessto_mphot_cat_column_desc pessto_mphot_cat >> ~/git_repos/_packages_/python/ep3/ep3/tests/input/pessto_phase_iii_schema.sql
...
perl -p -i.bak -e "s/ROW_FORMAT=DYNAMIC KEY_BLOCK_SIZE=8;/ROW_FORMAT=DYNAMIC;/g" ~/git_repos/_packages_/python/ep3/ep3/tests/input/pessto_phase_iii_schema.sql
