import os
import nose
from .. import export_pessto_object_summaries_for_wiserep
...
def setUpModule():
    ...
    dms.execute_mysql_script(
        ...
        db=connDict['db'],
        host=connDict['host'],
        pathToMysqlScript=pathToInputDir + "test_database_02.sql",
        force=True
    )
...
class test_command_line(unittest.TestCase):
    ...
    def test_command_line_method_01(self):
        ...
        export_pessto_object_summaries_for_wiserep.main(kwargs)
