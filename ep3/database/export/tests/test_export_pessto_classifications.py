import os
import nose
from .. import export_pessto_classifications
...
class test_command_line(unittest.TestCase):
    ...
    def test_command_line_method_01(self):
        ...
        export_pessto_classifications.main(kwargs)
    ...
    def test_command_line_method_02(self):
        ...
        kwargs["--exportFile"] = pathToOutputDir + \
            "pessto_classifications_export_02.csv"
        export_pessto_classifications.main(kwargs)
