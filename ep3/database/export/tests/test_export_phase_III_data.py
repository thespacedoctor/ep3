import os
import nose
from .. import export_phase_III_data
...
class test_command_line(unittest.TestCase):
    ...
    def test_command_line_method_01(self):
        ...
        kwargs["--dataType"] = "imaging"
        kwargs["--exportFolder"] = "/Users/Dave/Desktop/test_export"
        kwargs["--ssdr"] = 1
        export_phase_III_data.main(kwargs)

    def test_command_line_method_02(self):
        kwargs = {}
        kwargs["--settingsFile"] = pathToInputDir + "project_settings.yaml"
        kwargs["--dataType"] = "spectra"
