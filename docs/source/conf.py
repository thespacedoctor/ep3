...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.colors',
                'matplotlib.pyplot', 'matplotlib.cm', 'matplotlib.path', 'matplotlib.patches', 'matplotlib.projections', 'matplotlib.projections.geo', 'healpy', 'astropy', 'astropy.io', 'pylibmc', 'HMpTy', 'HMpTy.mysql', 'ligo', 'ligo.gracedb', 'ligo.gracedb.rest', 'pandas', 'dryxPython.csvtools', 'dryxPython']
...
html_theme_options = {
    ...
    'github_repo': 'ep3',
    'strap_line': "Processing of PESSTO data to make it comply with ESO Phase III"
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/ep3/tree/master"
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/ep3.rst']
modindex_common_prefix = ["ep3."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'ep3.tex', u'ep3 Documentation',
     u'Dave Young', 'manual'),
]
